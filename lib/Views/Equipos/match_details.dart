          ...
          children: [
            ...
            FloatingActionButton.extended(
              ...
              onPressed: () {
                ...
                if (teams[0].teamGoals > teams[1].teamGoals) {
                  teams[0].points += 3;
                }
                if (teams[0].teamGoals == teams[1].teamGoals) {
                  teams[0].points += 1;
                ...
                context.read<TeamBloc>().add(UpdateTeam(teams[0]));
                context.read<TeamBloc>().add(UpdateTeam(teams[1]));
